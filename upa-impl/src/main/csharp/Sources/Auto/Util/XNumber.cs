    ...
    public class XNumber {
        ...
        public virtual Net.Vpc.Upa.Impl.Util.XNumber Negate() {
            if (type == typeof(byte?)) {
                ...
                return new Net.Vpc.Upa.Impl.Util.XNumber(BigIntegerValue().Negate());
            } else if (type == typeof(System.Decimal)) {
                return new Net.Vpc.Upa.Impl.Util.XNumber(BigDecimalValue().Negate());
            }
        ...
        public virtual Net.Vpc.Upa.Impl.Util.XNumber Add(Net.Vpc.Upa.Impl.Util.XNumber other) {
            ...
            if (c == typeof(byte?)) {
                ...
                return new Net.Vpc.Upa.Impl.Util.XNumber(BigIntegerValue().Add(other.BigIntegerValue()));
            } else if (c == typeof(System.Decimal)) {
                return new Net.Vpc.Upa.Impl.Util.XNumber(BigDecimalValue().Add(other.BigDecimalValue()));
            }
            throw new System.ArgumentException ("Invalid");
        }
        ...
        public virtual Net.Vpc.Upa.Impl.Util.XNumber Subtract(Net.Vpc.Upa.Impl.Util.XNumber other) {
            ...
            if (c == typeof(byte?)) {
                ...
                return new Net.Vpc.Upa.Impl.Util.XNumber(BigIntegerValue().Subtract(other.BigIntegerValue()));
            } else if (c == typeof(System.Decimal)) {
                return new Net.Vpc.Upa.Impl.Util.XNumber(BigDecimalValue().Subtract(other.BigDecimalValue()));
            }
            throw new System.ArgumentException ("Invalid");
        }
        ...
        public virtual Net.Vpc.Upa.Impl.Util.XNumber Multiply(Net.Vpc.Upa.Impl.Util.XNumber other) {
            ...
            if (c == typeof(byte?)) {
                ...
                return new Net.Vpc.Upa.Impl.Util.XNumber(BigIntegerValue().Multiply(other.BigIntegerValue()));
            } else if (c == typeof(System.Decimal)) {
                return new Net.Vpc.Upa.Impl.Util.XNumber(BigDecimalValue().Multiply(other.BigDecimalValue()));
            }
            throw new System.ArgumentException ("Invalid");
        }
        ...
        public virtual Net.Vpc.Upa.Impl.Util.XNumber Divide(Net.Vpc.Upa.Impl.Util.XNumber other) {
            ...
            if (c == typeof(byte?)) {
                ...
                return new Net.Vpc.Upa.Impl.Util.XNumber(BigIntegerValue().Divide(other.BigIntegerValue()));
            } else if (c == typeof(System.Decimal)) {
                return new Net.Vpc.Upa.Impl.Util.XNumber(BigDecimalValue().Divide(other.BigDecimalValue()));
            }
            throw new System.ArgumentException ("Invalid");
        }
        ...
        public override int GetHashCode() {
            int hash = 7;
            hash = 67 * hash + Java.Util.Objects.GetHashCode(this.type);
            hash = 67 * hash + Java.Util.Objects.GetHashCode(this.number);
            return hash;
        }
        ...
        public virtual int ComparetTo(Net.Vpc.Upa.Impl.Util.XNumber other) {
            System.Type c = BestFit(type, other.type);
            if (c == typeof(byte?)) {
        ...
        public virtual System.Decimal BigDecimalValue() {
            ...
            if (IsInteger()) {
                if (number is System.Numerics.BigInteger?) {
                    return new System.Decimal((System.Numerics.BigInteger?) number);
                }
                return new System.Decimal(System.Convert.ToInt32(number));
            }
            if (IsFloating()) {
                return new System.Decimal(System.Convert.ToDouble(number));
            }
        ...
        public virtual System.Numerics.BigInteger? BigIntegerValue() {
            if (number is System.Decimal) {
                return ((System.Decimal) number).ToBigInteger();
            }
            if (IsInteger()) {
                if (number is System.Numerics.BigInteger?) {
            ...
            if (IsFloating()) {
                return new System.Decimal(System.Convert.ToDouble(number)).ToBigInteger();
            }
            throw new System.ArgumentException ("Invalid bigDecimaValue()");
        }
