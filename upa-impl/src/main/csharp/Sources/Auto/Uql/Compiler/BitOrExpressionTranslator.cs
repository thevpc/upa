...
namespace Net.Vpc.Upa.Impl.Uql.Compiler
{
    ...
    public class BitOrExpressionTranslator : Net.Vpc.Upa.Impl.Uql.ExpressionTranslator {
        ...
        public BitOrExpressionTranslator(Net.Vpc.Upa.Impl.Uql.ExpressionTranslationManager outer) {
            this.outer = outer;
        }
        ...
        public virtual Net.Vpc.Upa.Impl.Uql.Compiledexpression.DefaultCompiledExpression TranslateExpression(object o, Net.Vpc.Upa.Impl.Uql.ExpressionTranslationManager expressionTranslationManager, Net.Vpc.Upa.Impl.Uql.ExpressionDeclarationList declarations) {
            return CompileBitOr((Net.Vpc.Upa.Expressions.BitOr) o, declarations);
        }

        protected internal virtual Net.Vpc.Upa.Impl.Uql.Compiledexpression.CompiledBitOr CompileBitOr(Net.Vpc.Upa.Expressions.BitOr v, Net.Vpc.Upa.Impl.Uql.ExpressionDeclarationList declarations) {
            if (v == null) {
                return null;
            }
