...
namespace Net.Vpc.Upa.Impl.Uql.Compiler
{
     ...
     */
    public class MulExpressionTranslator : Net.Vpc.Upa.Impl.Uql.ExpressionTranslator {

        private readonly Net.Vpc.Upa.Impl.Uql.ExpressionTranslationManager outer;

        public MulExpressionTranslator(Net.Vpc.Upa.Impl.Uql.ExpressionTranslationManager outer) {
            this.outer = outer;
        }
        ...
        public virtual Net.Vpc.Upa.Impl.Uql.Compiledexpression.DefaultCompiledExpression TranslateExpression(object o, Net.Vpc.Upa.Impl.Uql.ExpressionTranslationManager expressionTranslationManager, Net.Vpc.Upa.Impl.Uql.ExpressionDeclarationList declarations) {
            return CompileMul((Net.Vpc.Upa.Expressions.Mul) o, declarations);
        }

        protected internal virtual Net.Vpc.Upa.Impl.Uql.Compiledexpression.CompiledMul CompileMul(Net.Vpc.Upa.Expressions.Mul v, Net.Vpc.Upa.Impl.Uql.ExpressionDeclarationList declarations) {
            if (v == null) {
                return null;
            }
            ...
            Net.Vpc.Upa.Impl.Uql.Compiledexpression.CompiledMul s = new Net.Vpc.Upa.Impl.Uql.Compiledexpression.CompiledMul(left, right);
