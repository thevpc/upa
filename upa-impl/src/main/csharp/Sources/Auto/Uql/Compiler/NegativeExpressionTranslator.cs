...
namespace Net.Vpc.Upa.Impl.Uql.Compiler
{
    ...
    public class NegativeExpressionTranslator : Net.Vpc.Upa.Impl.Uql.ExpressionTranslator {
        ...
        public NegativeExpressionTranslator(Net.Vpc.Upa.Impl.Uql.ExpressionTranslationManager outer) {
            this.outer = outer;
        }
        ...
        public virtual Net.Vpc.Upa.Impl.Uql.Compiledexpression.DefaultCompiledExpression TranslateExpression(object o, Net.Vpc.Upa.Impl.Uql.ExpressionTranslationManager expressionTranslationManager, Net.Vpc.Upa.Impl.Uql.ExpressionDeclarationList declarations) {
            ...
            return new Net.Vpc.Upa.Impl.Uql.Compiledexpression.CompiledNegative(outer.CompileAny(v.GetExpression(), declarations));
        }
    }
}
