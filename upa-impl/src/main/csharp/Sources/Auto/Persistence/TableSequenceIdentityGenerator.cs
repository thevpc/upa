...
namespace Net.Vpc.Upa.Impl.Persistence
{
     ...
     */
    public abstract class TableSequenceIdentityGenerator : Net.Vpc.Upa.Persistence.FieldPersister {
        ...
        public TableSequenceIdentityGenerator(Net.Vpc.Upa.Field field, Net.Vpc.Upa.Sequence sequence) {
        ...
        public override bool Equals(object o) {
            ...
            if (!(o is Net.Vpc.Upa.Impl.Persistence.TableSequenceIdentityGenerator)) {
                return false;
            }
            Net.Vpc.Upa.Impl.Persistence.TableSequenceIdentityGenerator that = (Net.Vpc.Upa.Impl.Persistence.TableSequenceIdentityGenerator) o;
