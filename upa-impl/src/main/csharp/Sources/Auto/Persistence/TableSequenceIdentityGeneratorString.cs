...
namespace Net.Vpc.Upa.Impl.Persistence
{
     ...
     */
    public class TableSequenceIdentityGeneratorString : Net.Vpc.Upa.Impl.Persistence.TableSequenceIdentityGenerator {

        public TableSequenceIdentityGeneratorString(Net.Vpc.Upa.Field field, Net.Vpc.Upa.Sequence generatedId)  : base(field, generatedId){
