...
namespace Net.Vpc.Upa.Impl.Persistence.Shared
{
     ...
     */
    public class MaxANSISQLProvider : Net.Vpc.Upa.Impl.Persistence.Shared.ANSIFunctionSQLProvider {

        public MaxANSISQLProvider()  : base(typeof(Net.Vpc.Upa.Impl.Uql.Compiledexpression.CompiledMax)){
