...
namespace Net.Vpc.Upa.Impl.Persistence.Shared
{
    ...
    * @creationdate 12/20/12 2:49 AM*/
    public class MonthYearMarshaller : Net.Vpc.Upa.Impl.Persistence.SimpleTypeMarshaller {
        ...
        public override object Read(int index, System.Data.IDataReader resultSet) /* throws System.Exception */  {
            ...
            return t == null ? null : new Net.Vpc.Upa.Types.Month(t);
        }
