...
namespace Net.Vpc.Upa.Impl.Persistence.Shared
{
     ...
     */
    public class SumANSISQLProvider : Net.Vpc.Upa.Impl.Persistence.Shared.ANSIFunctionSQLProvider {

        public SumANSISQLProvider()  : base(typeof(Net.Vpc.Upa.Impl.Uql.Compiledexpression.CompiledSum)){
