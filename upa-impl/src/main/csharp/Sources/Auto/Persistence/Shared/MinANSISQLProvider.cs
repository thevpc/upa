...
namespace Net.Vpc.Upa.Impl.Persistence.Shared
{
     ...
     */
    public class MinANSISQLProvider : Net.Vpc.Upa.Impl.Persistence.Shared.ANSIFunctionSQLProvider {

        public MinANSISQLProvider()  : base(typeof(Net.Vpc.Upa.Impl.Uql.Compiledexpression.CompiledMin)){
