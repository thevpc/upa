...
namespace Net.Vpc.Upa.Impl.Persistence.Specific.Mssqlserver
{
     ...
     */
    public class MSSQLServerCoalesceSQLProvider : Net.Vpc.Upa.Impl.Persistence.Specific.Mssqlserver.MSSQLServerFunctionSQLProvider {

        public MSSQLServerCoalesceSQLProvider()  : base(typeof(Net.Vpc.Upa.Impl.Uql.Compiledexpression.CompiledCoalesce)){
