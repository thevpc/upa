...
namespace Net.Vpc.Upa.Impl.Util
{
     ...
     */
    public class IteratorList<T> : System.Collections.Generic.IList<T>, Net.Vpc.Upa.Closeable {
        ...
        public IteratorList(System.Collections.Generic.IEnumerator<T> @base) {
            this.@base = @base;
        }
        ...
        {
            return new IteratorListIterator<T>(this, 0);
        }
