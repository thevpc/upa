...
public class BitAndExpressionTranslator implements ExpressionTranslator {
    ...
    public BitAndExpressionTranslator(final ExpressionTranslationManager outer) {
        this.outer = outer;
    }

    public DefaultCompiledExpression translateExpression(Object o, ExpressionTranslationManager expressionTranslationManager, ExpressionDeclarationList declarations) {
        return compileBitAnd((BitAnd) o, declarations);
    }

    protected CompiledBitAnd compileBitAnd(BitAnd v, ExpressionDeclarationList declarations) {
        if (v == null) {
            return null;
        }
