...
/** Compilation unit. */
  ...
  final public List<JoinCriteria> JoinList() throws ParseException {
  ...
  final public JoinCriteria JoinDec() throws ParseException {
  ...
  final public List<DecoratedExpression> NamedExpressionList() throws ParseException {
  ...
  final public List<DecoratedExpression> OrderExpressionList() throws ParseException {
    List<DecoratedExpression> r=new ArrayList<DecoratedExpression>();
    DecoratedExpression r0;
    DecoratedExpression ri;
    r0 = OrderExpression();
  ...
  final public DecoratedExpression OrderExpression() throws ParseException {
  ...
  final public DecoratedExpression NamedExpression() throws ParseException {
    DecoratedExpression r=new DecoratedExpression();
    Token t=null;
    switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
    case STAR:
  ...
  final public Expression PlusExpression() throws ParseException {
    Expression left;
    Expression right;
    BinaryOperator op;
    left = MulExpression();
  ...
  final public Expression MulExpression() throws ParseException {
    Expression left;
    Expression right;
    BinaryOperator op;
    left = PowExpression();
  ...
  final public Expression PowExpression() throws ParseException {
    Expression left;
    Expression right;
    BinaryOperator op;
  ...
  final public Expression Param() throws ParseException {
    Token t=null;
    jj_consume_token(COLON);
    t = jj_consume_token(IDENTIFIER);
        {if (true) return new Param(getIdentifierName(t));}
    throw new Error("Missing return statement in function");
  }

  final public Expression VarOrFunction() throws ParseException {
    Token t=null;
    Token start;
    boolean fct=false;
    ...
    if (jj_2_9(2147483647)) {
      ...
      while (true) {
        ...
        if(fct){
              {if (true) return FunctionFactory.createFunction(getIdentifierName(start),parameters==null?new ArrayList<Expression>():parameters);}
        }else if(indexer){
            if(parameters==null){
  ...
  final public Literal NullLiteral() throws ParseException {
   ...
   {if (true) return new Literal(null,null);}
    throw new Error("Missing return statement in function");
  }
...
//
  final public Expression Switch() throws ParseException {
    Expression e;
    ...
    jj_consume_token(END);
        {if (true) return new Decode(expressions);}
    throw new Error("Missing return statement in function");
  }

  final public Expression If() throws ParseException {
    Expression e;
    List<Expression> expressions=new ArrayList<Expression>();
    jj_consume_token(IF);
    e = Expression();
    ...
    jj_consume_token(END);
        {if (true) return new If(expressions);}
    throw new Error("Missing return statement in function");
  }
  ...
  final public Expression Function() throws ParseException {
    ...
    parameters = ExpressionList();
    jj_consume_token(RPAREN);
        {if (true) return FunctionFactory.createFunction(getIdentifierName(t),parameters);}
    throw new Error("Missing return statement in function");
  }
  ...
  static {
   ...
   private static void jj_la1_init_0() {
      jj_la1_0 = new int[] {0x1c08000,0x0,0x0,0x0,0x0,0x800,0xc0000000,0x1000,0x4000000,0x0,0x2000000,0x1000,0x1000,0xc0000000,0xc0000000,0x0,0x0,0x0,0x0,0x0,0x30000000,0x30000000,0x0,0x0,0x1c08000,0x0,0x4000,0x4000,0x2000,0x2000,0x1c08000,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x1c08000,0x1c08000,0x0,0x0,0x1c08000,0x0,0x0,0x1c00000,0xc00000,0x40000,0x80000,0x100000,0x80000,};
   }
   private static void jj_la1_init_1() {
      jj_la1_1 = new int[] {0x4e8840,0x400,0x200,0x80000,0x480000,0x0,0x7,0x0,0x0,0x10,0x0,0x0,0x0,0x7,0x7,0x80000,0x480000,0x20,0x20000000,0x20000000,0x0,0x0,0x40000000,0x80000,0x4e8840,0x20000000,0x0,0x0,0x0,0x0,0x4e8840,0x80000080,0x80000180,0x0,0x0,0x0,0x0,0x0,0x0,0x4e8840,0x4e8840,0x40000000,0x80000,0x4e8840,0x400040,0x80000,0x68800,0x0,0x0,0x0,0x0,0x0,};
   }
