...
public class EntityPlatformBeanType implements PlatformBeanType {
    ...
    private PlatformBeanType platformPlatformBeanType;
    ...
    public EntityPlatformBeanType(Entity entity) {
        this.platformPlatformBeanType = PlatformBeanTypeRepository.getInstance().getBeanType(entity.getEntityType());
        this.entity = entity;
        try {
