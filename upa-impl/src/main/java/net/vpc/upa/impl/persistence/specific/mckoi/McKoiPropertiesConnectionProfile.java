...
// */
//package net.vpc.upa.impl.persistence.mckoi;
//
//
//import net.vpc.upa.impl.persistence.connection.DefaultPropertiesConnectionProfile;
//import net.vpc.upa.persistence.connection.ConnectionProfile;
