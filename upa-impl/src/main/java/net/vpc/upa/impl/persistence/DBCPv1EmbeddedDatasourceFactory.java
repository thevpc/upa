...
import net.vpc.upa.impl.util.PlatformLenientType;
...
public class DBCPv1EmbeddedDatasourceFactory implements EmbeddedDatasourceFactory {
    protected static Logger log = Logger.getLogger(DBCPv1EmbeddedDatasourceFactory.class.getName());
    public static final DBCPv1EmbeddedDatasourceFactory INSTANCE = new DBCPv1EmbeddedDatasourceFactory();
        ...
        for (Map.Entry<String, String> ee : properties.entrySet()) {
            ...
            if (!key.contains(".") && key.startsWith("pool")) {
                ...
                if (key.equals("poolInitialSize")) {
                    ...
                    DBCP_TYPE.setPropertyAsString(ds, "maxActive", val);
