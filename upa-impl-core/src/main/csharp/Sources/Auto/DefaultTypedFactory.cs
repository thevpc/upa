...
namespace Net.TheVpc.Upa.Impl
{
     ...
     */
    public class DefaultTypedFactory : Net.TheVpc.Upa.ObjectFactory {

        private static readonly System.Diagnostics.TraceSource log = new System.Diagnostics.TraceSource((typeof(Net.TheVpc.Upa.Impl.DefaultTypedFactory)).FullName);
        ...
        public virtual  T CreateObject<T>(string typeName) {
            try {
                System.Type type = (System.Type) Net.TheVpc.Upa.Impl.Util.PlatformUtils.ForName(typeName);
