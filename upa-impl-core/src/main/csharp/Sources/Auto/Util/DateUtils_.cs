...
namespace Net.Vpc.Upa.Impl.Util
{
    ...
    private const string UNIVERSAL_TIME_FORMAT = "HH:mm:ss";
        ...
        public static Net.Vpc.Upa.Types.Month ParseUniversalMonth(System.String date) {
            return new Net.Vpc.Upa.Types.Month(ParseDateTime(date, UNIVERSAL_TIME_FORMAT).GetTime());
        }

        public static Net.Vpc.Upa.Types.Timestamp ParseUniversalTimestamp(System.String date) {
