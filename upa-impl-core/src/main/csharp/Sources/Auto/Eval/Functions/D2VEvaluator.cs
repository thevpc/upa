...
namespace Net.TheVpc.Upa.Impl.Eval.Functions
{
     ...
     */
    public class D2VEvaluator : Net.TheVpc.Upa.Function {

        public static readonly Net.TheVpc.Upa.Function INSTANCE = new Net.TheVpc.Upa.Impl.Eval.Functions.D2VEvaluator();
