...
namespace Net.TheVpc.Upa.Impl.Persistence.Shared
{
     ...
     */
    public class CountANSISQLProvider : Net.TheVpc.Upa.Impl.Persistence.Shared.ANSIFunctionSQLProvider {

        public CountANSISQLProvider()  : base(typeof(Net.TheVpc.Upa.Impl.Uql.Compiledexpression.CompiledCount)){
