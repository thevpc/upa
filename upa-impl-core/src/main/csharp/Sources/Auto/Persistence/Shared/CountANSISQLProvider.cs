...
namespace Net.Vpc.Upa.Impl.Persistence.Shared
{
     ...
     */
    public class CountANSISQLProvider : Net.Vpc.Upa.Impl.Persistence.Shared.ANSIFunctionSQLProvider {

        public CountANSISQLProvider()  : base(typeof(Net.Vpc.Upa.Impl.Uql.Compiledexpression.CompiledCount)){
