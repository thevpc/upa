...
namespace Net.TheVpc.Upa.Impl.Persistence.Shared
{
     ...
     */
    public class MinANSISQLProvider : Net.TheVpc.Upa.Impl.Persistence.Shared.ANSIFunctionSQLProvider {

        public MinANSISQLProvider()  : base(typeof(Net.TheVpc.Upa.Impl.Uql.Compiledexpression.CompiledMin)){
        ...
        public override string Simplify(string functionName, string[] @params, System.Collections.Generic.IDictionary<string , object> context) {
            if (@params.Length != 1) {
                ...
                System.Text.StringBuilder sb = new System.Text.StringBuilder("Min(");
                sb.Append(@params[0]);
                sb.Append(")");
                return sb.ToString();
            }
