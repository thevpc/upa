...
namespace Net.TheVpc.Upa.Impl.Persistence.Shared
{
     ...
     */
    public class NullValANSISQLProvider : Net.TheVpc.Upa.Impl.Persistence.Shared.ANSIFunctionSQLProvider {

        public NullValANSISQLProvider()  : base(typeof(Net.TheVpc.Upa.Impl.Uql.Compiledexpression.CompiledNullVal)){
