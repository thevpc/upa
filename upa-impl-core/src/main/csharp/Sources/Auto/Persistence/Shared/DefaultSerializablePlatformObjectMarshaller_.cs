...
namespace Net.TheVpc.Upa.Impl.Persistence.Shared
{
    ...
    {
         public void SetMarshallManager(Net.TheVpc.Upa.Impl.Persistence.MarshallManager marshallManager)
        {
                 }
         ...
         public void Write(object @object, int i, System.Data.IDataReader updatableResultSet) /* throws System.Exception */
    {
         ...
         public Net.TheVpc.Upa.Types.DataType GetPersistentDataType(Net.TheVpc.Upa.Types.DataType datatype){
         return null;
         }
    }
}
