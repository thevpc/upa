...
namespace Net.TheVpc.Upa.Impl.Persistence.Shared
{
     ...
     */
    public class SumANSISQLProvider : Net.TheVpc.Upa.Impl.Persistence.Shared.ANSIFunctionSQLProvider {

        public SumANSISQLProvider()  : base(typeof(Net.TheVpc.Upa.Impl.Uql.Compiledexpression.CompiledSum)){
        ...
        public override string Simplify(string functionName, string[] @params, System.Collections.Generic.IDictionary<string , object> context) {
            if (@params.Length != 1) {
                ...
                System.Text.StringBuilder sb = new System.Text.StringBuilder("Sum(");
                sb.Append(@params[0]);
                sb.Append(")");
                return sb.ToString();
            }
