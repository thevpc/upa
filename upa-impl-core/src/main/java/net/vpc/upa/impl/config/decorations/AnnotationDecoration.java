    ...
    public ConfigInfo getConfig() {
        if (configInfo == null) {
            try {
                ...
                if (method != null && method.getReturnType().getName().equals(ItemConfig.class.getName())) {
    ...
    protected Map<String, DecorationValue> getAttributes0() {
        if (values == null) {
            ...
            for (Method declaredMethod : ann.annotationType().getMethods()) {
                ...
                if (declaredMethod.getParameterTypes().length == 0 && !mname.equals("equals") && !mname.equals("hashCode") && !mname.equals("toString")) {
