...
public class JdbcNativeResult implements NativeResult {
    ...
    @Override
    public net.thevpc.upa.types.Blob getBlob(int index) {
        try {
    ...
    @Override
    public void updateBlob(int i, net.thevpc.upa.types.Blob blob) {
        try {
    ...
    @Override
    public net.thevpc.upa.types.Clob getClob(int index) {
        try {
    ...
    @Override
    public void updateClob(int i, net.thevpc.upa.types.Clob clob) {
        try {
