...
import net.thevpc.upa.PlatformBeanProperty;
import net.thevpc.upa.PlatformBeanType;
import net.thevpc.upa.PropertyAccessType;
 ...
 */
public class PlatformBeanTypeCache implements PlatformBeanType{
    private static final Logger log = Logger.getLogger(PlatformBeanTypeCache.class.getName());
...
//    private Constructor constructor;
    ...
    public PlatformBeanTypeCache(Class platformType) {
...
//                        }
            ...
            for (PlatformBeanPropertyResolver ii : properties.values()) {
                ii.propertyType = ii.getter != null ? ii.getter.getReturnType() : ii.setter != null ? ii.setter.getParameterTypes()[0] : ii.field != null ? ii.field.getType() : null;
            }
        }
    }
...
//    @Override
    public PlatformBeanProperty getProperty(String propertyName, PropertyAccessType propertyAccessType) {
        PlatformBeanPropertyResolver f = properties.get(propertyName);
        if (f != null) {
...
//    }
    ...
    @Override
    public Object getPropertyValue(Object instance, String field) {
        return getPropertyValue(instance,field,PropertyAccessType.DEFAULT);
    }

    @Override
    public boolean setPropertyValue(Object instance, String property, Object value) {
        return setPropertyValue(instance,property,value,PropertyAccessType.DEFAULT);
    }
}
