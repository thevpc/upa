...
import net.thevpc.upa.impl.util.EqualsStringFilter;
import net.thevpc.upa.impl.util.PlatformUtils;
import net.thevpc.upa.impl.util.SimpleEntityFilter;
...
import net.thevpc.upa.config.*;
import net.thevpc.upa.config.OnInit;
...
//                net.thevpc.upa.config.FunctionDefinition d = type.getAnnotation();
    ...
    public static void configureMethodCallback(Class type, Method method, Decoration methodDecoration, PersistenceUnit persistenceUnit) {
        ...
        } else if (methodDecoration.isName(net.thevpc.upa.config.Function.class)) {
        ...
        } else if (methodDecoration.isName(NamedFormula.class)) {
