...
import net.thevpc.upa.persistence.UnionQueryInfo;
...
import net.thevpc.upa.impl.util.CompareUtils;
...
//    }
    void parseEntityType(DecorationEntityDescriptor entityInfo, Class type, boolean parseFields, boolean parseModifiers, boolean parseExtensions, ObjectFactory factory) {
        ...
        for (Decoration indexAnn : repo.getTypeRepeatableDecorations(type, Index.class, Indexes.class)) {
        ...
        //        net.thevpc.upa.config.Sequence gue = (net.thevpc.upa.config.Sequence) dataType.getAnnotation(Sequence.class);
//        if (gue != null) {
...
//                    UnionEntityEntry[] entities = unionEntity.entities();
    ...
    public String getFieldName(java.lang.reflect.Field javaField) {
        ...
        if (acceptField(javaField)) {
            Decoration anno = repo.getFieldDecoration(javaField, Field.class);
            if (anno != null) {
