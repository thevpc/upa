...
import net.thevpc.upa.impl.config.URLAnnotationStrategySupport;
...
import net.thevpc.upa.impl.event.PersistenceGroupListenerManager;
...
import net.thevpc.upa.exceptions.*;
import net.thevpc.upa.impl.config.ConfigureScanListener;
    ...
    public void setCurrentSession(Session session) throws UPAException {
        synchronized (sessions) {
            if (!sessions.contains(session)) {
                throw new NoSuchUPAElementException("Session not found");
            }
        }
