...
//*/
//class DefinitionListenerManagerBeforeRemovePropertyChangeListener implements PropertyChangeListener {
//    private PersistenceUnitListenerManager persistenceUnitListenerManager;
//
//    public DefinitionListenerManagerBeforeRemovePropertyChangeListener(PersistenceUnitListenerManager persistenceUnitListenerManager) {
...
//        persistenceUnitListenerManager.itemRemoved(o, (Integer) newValue[1], EventPhase.BEFORE);
//    }
//}
