...
*/
public class StringToBlobUTFMarshallerFactory implements TypeMarshallerFactory {
    ...
    public StringToBlobUTFMarshallerFactory(MarshallManager marshallManager,int maxString) {
    ...
    public void setMarshallManager(MarshallManager marshallManager) {
        ...
        blob=marshallManager.getTypeMarshaller(TypeMarshallerNames.STRING_TO_BLOB);
    }
}
