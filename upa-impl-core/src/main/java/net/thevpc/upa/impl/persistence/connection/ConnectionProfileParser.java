...
public class ConnectionProfileParser {
    ...
    public List<ConnectionProfile> parse(net.thevpc.upa.Properties p2, ConnectionConfig[] connectionConfigsArr, String prefix0, boolean enabledOnly) {
...
//    }
    ...
    public ConnectionProfile parse(net.thevpc.upa.Properties parameters, String connectionStringPropertyName) {
...
//            }
    ...
    protected void setParam(DefaultConnectionProfile d, String propertyName, String propertyValue, net.thevpc.upa.Properties parameters, String connectionStringPropertyName) {
