...
import net.thevpc.upa.impl.config.*;
...
import net.thevpc.upa.impl.eval.CustomFormulaCallback;
import net.thevpc.upa.impl.eval.CustomMultiFormulaCallback;
import net.thevpc.upa.impl.eval.functions.FunctionCallback;
import net.thevpc.upa.impl.eval.functions.PasswordQLFunction;
...
import net.thevpc.upa.impl.extension.HierarchicalRelationshipDataInterceptor;
import net.thevpc.upa.impl.extension.HierarchicalRelationshipSupport;
import net.thevpc.upa.impl.persistence.CloseOnContextPopSessionListener;
import net.thevpc.upa.impl.persistence.connection.ConnectionProfileParser;
import net.thevpc.upa.impl.transform.DefaultPasswordStrategy;
import net.thevpc.upa.impl.upql.DefaultExpressionManager;
...
//            }
    ...
    private List<ConnectionProfile> getConnectionProfiles(boolean root, boolean enabledOnly) {
        ...
        net.thevpc.upa.Properties p2 = new DefaultProperties(getProperties());
...
//
    //--------------------------- PROPERTIES SUPPORT
    @Override
    public net.thevpc.upa.Properties getProperties() {
        return properties;
    }
...
//        getResources().loadBundle("net.thevpc.database.resources.PersistenceUnitFilter");
//    }
    @Override
