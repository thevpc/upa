...
import net.thevpc.upa.exceptions.DatabaseNotFoundException;
...
import net.thevpc.upa.impl.persistence.shared.marshallers.StringToClobUTFMarshallerFactory;
...
//    private Set<String> keywords;
    ...
    protected Set<String> getCustomReservedKeywords() {
         ...
         */
        resourcePath = "net/thevpc/upa/impl/persistence/DerbyKeywords.txt";
