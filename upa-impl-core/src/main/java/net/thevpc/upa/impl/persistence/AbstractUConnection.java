...
import net.thevpc.upa.expressions.QueryScript;
import net.thevpc.upa.impl.UPAImplDefaults;
import net.thevpc.upa.impl.UPAImplKeys;
import net.thevpc.upa.impl.persistence.connection.CloseListenerSupport;
...
public abstract class AbstractUConnection implements UConnection {
    ...
    protected net.thevpc.upa.Properties perfProperties;
