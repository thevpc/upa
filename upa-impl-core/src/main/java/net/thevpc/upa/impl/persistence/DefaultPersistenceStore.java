...
import net.thevpc.upa.exceptions.ConnectionException;
import net.thevpc.upa.exceptions.DriverNotFoundException;
import net.thevpc.upa.exceptions.RootConnectionStringNotFoundException;
import net.thevpc.upa.exceptions.UPAException;
import net.thevpc.upa.impl.util.*;
import net.thevpc.upa.impl.util.PlatformUtils;
import net.thevpc.upa.persistence.ConnectionOption;
...
//            Map<String, String> properties = p.getProperties();
    ...
    protected Connection createPlatformConnection(String driver,
        ...
        try {
            net.thevpc.upa.Properties uproperties = this.properties;
