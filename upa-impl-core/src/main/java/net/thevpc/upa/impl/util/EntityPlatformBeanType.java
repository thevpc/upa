...
public class EntityPlatformBeanType implements PlatformBeanType {
    ...
    public EntityPlatformBeanType(Entity entity) {
        ...
        try {
            ...
            throw new IllegalUPAArgumentException("Unable to resolve default constructor for type " + entity.getEntityType() + " (entity " + entity.getName() + ")", e);
        }
        for (net.thevpc.upa.Field field : entity.getFields()) {
