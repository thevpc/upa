...
import net.thevpc.upa.bulk.DataDeserializer;
import net.thevpc.upa.bulk.DataColumn;
import net.thevpc.upa.bulk.DataReader;
import net.thevpc.upa.bulk.DataRow;
import net.thevpc.upa.bulk.ValueConverter;
import net.thevpc.upa.bulk.ValueValidator;
...
public abstract class AbstractDataReader implements DataReader {
    ...
    public Object readObject() {
        ...
        if (od == null) {
            throw new IllegalUPAArgumentException("Missing Object deserializer");
        }
