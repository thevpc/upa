...
import net.thevpc.upa.impl.xml.XmlDomNode;
import net.thevpc.upa.impl.xml.XMLUtils;
import net.thevpc.upa.impl.xml.XmlDomElement;
import net.thevpc.upa.impl.xml.XmlAttrListFilter;
import net.thevpc.upa.impl.xml.XmlDomText;
