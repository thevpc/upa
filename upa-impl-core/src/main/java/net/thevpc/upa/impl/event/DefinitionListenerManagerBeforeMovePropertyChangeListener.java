...
//*/
//class DefinitionListenerManagerBeforeMovePropertyChangeListener implements PropertyChangeListener {
//    private PersistenceUnitListenerManager persistenceUnitListenerManager;
//
//    public DefinitionListenerManagerBeforeMovePropertyChangeListener(PersistenceUnitListenerManager persistenceUnitListenerManager) {
...
//        persistenceUnitListenerManager.itemMoved(o, (Integer) newValue[1], (Integer) newValue[2], EventPhase.BEFORE);
//    }
//}
