...
import net.thevpc.upa.impl.upql.ext.expr.CompiledOrderItem;
import net.thevpc.upa.impl.upql.ext.expr.CompiledURShift;
import net.thevpc.upa.impl.upql.ext.expr.CompiledBitAnd;
...
import net.thevpc.upa.impl.upql.ext.expr.CompiledReminder;
...
//            validateCompiledVar(v, config);
                throw new NoSuchFieldException("?", var.toString(), var.getName());
            } else {
                ...
                if (ref instanceof Entity) {
                    ...
                    throw new NoSuchFieldException(ee.getName(), var.toString(), var.getName());
                    ...
                    if (manyToOneRelationship != null) {
                        ...
                        throw new NoSuchFieldException(null, var.toString(), var.getName());
                    }
                }
                throw new NoSuchFieldException(null, var.toString(), var.getName());
            }
