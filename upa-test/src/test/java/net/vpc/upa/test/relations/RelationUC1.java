 ...
 */
public class RelationUC1 {

    private static final Logger log = Logger.getLogger(RelationUC1.class.getName());
    private static Business bo;

    @BeforeClass
    public static void setup() {
        PUUtils.reset();
        PersistenceUnit pu = PUUtils.createTestPersistenceUnit(RelationUC1.class);
