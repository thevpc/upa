...
//import net.vpc.upa.impl.DefaultParameters;
//import net.vpc.upa.Parameters;
...
//    @Test
//    public void test1(){
//        ConnectionProfile actual = parse("derby#10.6:default#9://localhost:1521/c:/r/t/y/mydb;n1=v1;n2=v2;structure=mandatory",new DefaultParameters());
//
//        DefaultConnectionProfile expected=new DefaultConnectionProfile();
//        expected.setStructureStrategy(StructureStrategy.MANDATORY);
//        expected.setConnectionDriver(ConnectionDriver.DEFAULT);
...
//    @Test
//    public void test2(){
//        ConnectionProfile actual = parse("derby:default://localhost:1521/c:/r/t/y/mydb;n1=v1;n2=v2;structure=mandatory",new DefaultParameters());
//
//        DefaultConnectionProfile expected=new DefaultConnectionProfile();
//        expected.setStructureStrategy(StructureStrategy.MANDATORY);
//        expected.setConnectionDriver(ConnectionDriver.DEFAULT);
...
//        DefaultConnectionProfile expected=new DefaultConnectionProfile();
//        expected.setStructureStrategy(StructureStrategy.MANDATORY);
//        expected.setConnectionDriver(ConnectionDriver.GENERIC);
//        expected.setDatabaseProduct(DatabaseProduct.DERBY);
//        expected.setProperties(new HashMap<String, String>());
...
//    }
//
//    private ConnectionProfile parse(String connectionString,Parameters parameters){
