 ...
 */
public class RelationUC2 {

    private static final Logger log = Logger.getLogger(RelationUC2.class.getName());

    private static Business bo;
    @BeforeClass
    public static void setup() {
        PUUtils.reset();
        PersistenceUnit pu = PUUtils.createTestPersistenceUnit(RelationUC2.class);
