package net.thevpc.upa.test.runtime;

import net.thevpc.upa.Query;
import net.thevpc.upa.UPA;
import net.thevpc.upa.config.*;
import net.thevpc.upa.test.types.*;
...
public class RuntimeClosingResultSetsUC {
    ...
    public static void setup() {
        PUUtils.reset();
        net.thevpc.upa.PersistenceUnit pu = PUUtils.createTestPersistenceUnit(RuntimeClosingResultSetsUC.class);
