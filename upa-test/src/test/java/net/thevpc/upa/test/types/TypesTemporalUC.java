...
public class TypesTemporalUC {
    ...
    public static class Business {
        ...
        public void process() {
            ...
            d.setVdate(new net.thevpc.upa.types.Date());
            d.setVdatetime(new DateTime());
    ...
    public static class TemporalData{
        ...
        private Date javaTs;
        private net.thevpc.upa.types.Date vdate;
        private DateTime vdatetime;
        private Time vtime;
        private Month vmonth;
        private Year vyear;
        ...
        public net.thevpc.upa.types.Date getVdate() {
            return vdate;
        }

        public void setVdate(net.thevpc.upa.types.Date vdate) {
            this.vdate = vdate;
        }
