...
public interface ImportPersistenceUnitListener {
    ...
    void objectPersistFailed(String entityName, Object source, Object target, Exception error);

    void objectMergeFailed(String entityName, Object source, Object target, Exception error);
}
