...
public class OneToOneType extends RelationDataType implements Cloneable {
...
//    }
    public OneToOneType(Class entityType, String entityName, boolean nullable) {
        this(null, entityType, entityName, true, nullable);
    }

    public OneToOneType(Class entityType, boolean nullable) {
        this(null, entityType, entityType.getSimpleName(), true, nullable);
    }

    public OneToOneType(String typeName, Class entityType, String entityName, boolean updatable, boolean nullable) {
    ...
    public boolean equals(Object o) {
        ...
        OneToOneType that = (OneToOneType) o;
