...
import net.thevpc.upa.UnspecifiedValue;
...
public class FieldDesc {
    ...
    public FieldDesc setFormula(Formula formula) {
        setPersistFormula(formula);
        setUpdateFormula(formula);
        return this;
    }

    public FieldDesc setPersistFormula(Formula persistFormula) {
        this.persistFormula = persistFormula;
        this.persistFormulaSet = true;
        return this;
    }

    public FieldDesc setUpdateFormula(Formula updateFormula) {
