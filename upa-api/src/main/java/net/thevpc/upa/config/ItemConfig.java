...
public @interface ItemConfig {
    ...
    String packagePath() default UPA.UNDEFINED_STRING;

    String persistenceUnit() default UPA.UNDEFINED_STRING;

    String persistenceGroup() default UPA.UNDEFINED_STRING;
