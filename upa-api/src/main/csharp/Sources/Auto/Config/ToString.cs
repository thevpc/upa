...
namespace Net.TheVpc.Upa.Config
{
    ...
    public class ToString : System.Attribute {
        ...
        /**
             ...
             */
        private Net.TheVpc.Upa.Config.StringEncoderType _Value = Net.TheVpc.Upa.Config.StringEncoderType.DEFAULT;
        public  Net.TheVpc.Upa.Config.StringEncoderType Value{
            get {return _Value;}
            set {_Value=value;}
        }
