...
namespace Net.Vpc.Upa.Callbacks
{
    ...
    public class SingleDataInterceptorAdapter : Net.Vpc.Upa.Callbacks.SingleEntityListener {
        ...
        public virtual void BeforeDelete(Net.Vpc.Upa.Callbacks.EntityTriggerContext context, object id) /* throws Net.Vpc.Upa.Exceptions.UPAException */  {
        }


        public virtual void AfterDelete(Net.Vpc.Upa.Callbacks.EntityTriggerContext context, object id) /* throws Net.Vpc.Upa.Exceptions.UPAException */  {
        }
