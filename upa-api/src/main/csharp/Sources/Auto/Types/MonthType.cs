...
namespace Net.TheVpc.Upa.Types
{
    ...
    public class MonthType : Net.TheVpc.Upa.Types.TemporalType {

        public static readonly Net.TheVpc.Upa.Types.MonthType DEFAULT = new Net.TheVpc.Upa.Types.MonthType("MONTH", null, true);

        protected internal Net.TheVpc.Upa.Types.Month min = null;

        protected internal Net.TheVpc.Upa.Types.Month max = null;

        public MonthType(string name, System.Type type, bool nullable)  : this(name, type, null, null, nullable){

        }

        public MonthType(string name, System.Type type, Net.TheVpc.Upa.Types.Month min, Net.TheVpc.Upa.Types.Month max, bool nullable)  : base(name, type == null ? typeof(Net.TheVpc.Upa.Types.Month) : type, 0, 0, nullable){

            if (type != null && !type.Equals(typeof(Net.TheVpc.Upa.Types.Month)) && !type.Equals(typeof(Net.TheVpc.Upa.Types.Temporal))) {
        ...
        public override Net.TheVpc.Upa.Types.TemporalOption GetTemporalOption() {
            return Net.TheVpc.Upa.Types.TemporalOption.MONTH;
        }
        ...
        public virtual Net.TheVpc.Upa.Types.Month GetMin() {
            return min;
        }

        public virtual void SetMin(Net.TheVpc.Upa.Types.Month newMin) {
            min = newMin;
        }

        public virtual Net.TheVpc.Upa.Types.Month GetMax() {
            return max;
        }

        public virtual void SetMax(Net.TheVpc.Upa.Types.Month newMax) {
            max = newMax;
        }
        ...
        public override Net.TheVpc.Upa.Types.Temporal ValidateDate(Net.TheVpc.Upa.Types.Temporal date) {
            ...
            if (typeof(Net.TheVpc.Upa.Types.Month).IsAssignableFrom(type)) {
                return new Net.TheVpc.Upa.Types.Month(time);
        ...
        public override bool Equals(object o) {
            ...
            Net.TheVpc.Upa.Types.MonthType monthType = (Net.TheVpc.Upa.Types.MonthType) o;
        ...
        public override Net.TheVpc.Upa.DataTypeInfo GetInfo() {
            ...
            if (min != null) {
                d.GetProperties()["min"]=System.Convert.ToString(Net.TheVpc.Upa.Types.PlatformUtils.FormatUniversalMonthYear(min));
            }
            if (max != null) {
                d.GetProperties()["max"]=System.Convert.ToString(Net.TheVpc.Upa.Types.PlatformUtils.FormatUniversalMonthYear(max));
            }
            return d;
        }
        ...
        public override Net.TheVpc.Upa.Types.Temporal Parse(string @value) {
            ...
            return ValidateDate(Net.TheVpc.Upa.Types.PlatformUtils.ParseUniversalMonthYear(@value));
        }
    }
}
