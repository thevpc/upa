...
namespace Net.Vpc.Upa.Types
{
    ...
    public partial class DataType : System.ICloneable {
        ...
        public DataType(string name, System.Type platformType)  : this(name, platformType, 0, 0, false){

        }

        public DataType(string name, System.Type platformType, bool nullable)  : this(name, platformType, 0, 0, nullable){

        }

        public DataType(string name, System.Type platformType, int scale, int precision, bool nullable) {
            this.name = name;
        ...
        public virtual object Clone() {
            try {
                Net.Vpc.Upa.Types.DataType cloned = (Net.Vpc.Upa.Types.DataType) base.MemberwiseClone();
