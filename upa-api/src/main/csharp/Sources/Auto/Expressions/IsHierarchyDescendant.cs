...
namespace Net.Vpc.Upa.Expressions
{
    ...
    public sealed class IsHierarchyDescendant : Net.Vpc.Upa.Expressions.FunctionExpression {
        ...
        public IsHierarchyDescendant(Net.Vpc.Upa.Expressions.Expression[] expressions) {
            CheckArgCount(GetName(), expressions, 3);
            Init(expressions[0], expressions[1], expressions[2]);
        }

        public IsHierarchyDescendant(Net.Vpc.Upa.Expressions.Expression ancestorExpression, Net.Vpc.Upa.Expressions.Expression childExpression, Net.Vpc.Upa.Expressions.Expression entityName) {
            ...
            if (entityName != null) {
                if (entityName is Net.Vpc.Upa.Expressions.EntityName) {
                    ...
                    if (v.GetApplier() != null) {
                        throw new Net.Vpc.Upa.Exceptions.UPAIllegalArgumentException("Invalid EntityName");
                    }
        ...
        public override Net.Vpc.Upa.Expressions.Expression Copy() {
            Net.Vpc.Upa.Expressions.IsHierarchyDescendant o = new Net.Vpc.Upa.Expressions.IsHierarchyDescendant(ancestorExpression.Copy(), childExpression.Copy(), (Net.Vpc.Upa.Expressions.EntityName) entityName.Copy());
            return o;
        }
    }
}
