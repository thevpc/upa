...
namespace Net.TheVpc.Upa.Expressions
{
    ...
    public class D2V : Net.TheVpc.Upa.Expressions.FunctionExpression {



        private Net.TheVpc.Upa.Expressions.Expression expression;

        public D2V(Net.TheVpc.Upa.Expressions.Expression expression) {
            this.expression = expression;
        }

        public D2V(Net.TheVpc.Upa.Expressions.Expression[] expressions) {
        ...
        public override Net.TheVpc.Upa.Expressions.Expression Copy() {
            Net.TheVpc.Upa.Expressions.D2V o = new Net.TheVpc.Upa.Expressions.D2V(expression.Copy());
            return o;
        }
    }
}
