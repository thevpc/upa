...
namespace Net.TheVpc.Upa.Expressions
{
     ...
     */
    public class DatePart : Net.TheVpc.Upa.Expressions.FunctionExpression {
        ...
        public DatePart(Net.TheVpc.Upa.Expressions.Expression[] expressions) {
        ...
        public DatePart(Net.TheVpc.Upa.Expressions.DatePartType type, Net.TheVpc.Upa.Types.Temporal date)  : this(type, new Net.TheVpc.Upa.Expressions.Literal(date)){

        }

        public DatePart(Net.TheVpc.Upa.Expressions.DatePartType type, string varDate)  : this(type, new Net.TheVpc.Upa.Expressions.UserExpression(varDate)){

        }

        public DatePart(Net.TheVpc.Upa.Expressions.DatePartType type, Net.TheVpc.Upa.Expressions.Expression val) {
            Init(type, val);
        }
        ...
        public override Net.TheVpc.Upa.Expressions.Expression Copy() {
            Net.TheVpc.Upa.Expressions.DatePart o = new Net.TheVpc.Upa.Expressions.DatePart(type, @value);
            return o;
        }
    }
}
