package net.thevpc.upa.test.v1_0_2_29.formulas;
...
public class FormulaUC2 {
    ...
    public static class Person {
        ...
        @net.thevpc.upa.config.Formula(type = FormulaType.LIVE, value = "concat(this.name,this.name)")
        private String goodName;

        @net.thevpc.upa.config.Formula(type = FormulaType.LIVE, value = "concat(this.name,this.id)")
