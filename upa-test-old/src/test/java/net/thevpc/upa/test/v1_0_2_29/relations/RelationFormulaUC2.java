...
//            System.out.println(r);
    ...
    public static class Person2 {
        ...
        @net.thevpc.upa.config.Formula(type = FormulaType.LIVE, value = "(this.phone.number+'!!')")
    ...
    public static class Person3 {
        ...
        @net.thevpc.upa.config.Formula(type = FormulaType.LIVE, value = "this.phone.country")
