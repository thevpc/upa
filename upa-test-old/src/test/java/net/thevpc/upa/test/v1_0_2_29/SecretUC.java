...
import net.thevpc.upa.config.ToString;
import net.thevpc.upa.config.Id;
import net.thevpc.upa.config.Ignore;
import net.thevpc.upa.config.Password;
import net.thevpc.upa.config.Secret;
import net.thevpc.upa.config.ToByteArray;
import net.thevpc.upa.config.StringEncoderType;
