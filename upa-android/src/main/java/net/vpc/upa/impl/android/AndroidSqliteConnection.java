...
import net.vpc.upa.impl.persistence.AbstractUConnection;
import net.vpc.upa.impl.persistence.DefaultQueryResult;
import net.vpc.upa.impl.persistence.DefaultUConnection;
